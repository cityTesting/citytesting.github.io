...
2. Import server public cert into client truststore:
...
3. Import client public cert into server truststore:
...
4. Create p12 certificate for using it in Postman:
...
5. Run Wiremock, we are using docker:
